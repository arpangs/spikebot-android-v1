...
import com.spike.bot.receiver.OnChartGestureListener;
...
public class HeavyLoadDetailActivity extends AppCompatActivity  {
    ...
    private void setSPinner() {
        ...
        ArrayAdapter adapterMonth = new ArrayAdapter<String>(this,
                R.layout.item_spinner_selected_month, Constants.getMonthList());
...
//                        return String.valueOf(getXAxisValues().get((int) value));
                ...
                formatter = new IAxisValueFormatter() {
                    ...
                    public String getFormattedValue(float value, AxisBase axis) {
                        ...
                        ChatApplication.logDisplay("value is "+value);
                        return String.valueOf(arrayDayTemp.get((int) value));
                    }
                };
            }
