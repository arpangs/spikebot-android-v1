...
public class AddTTlockToRoomActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String room_id="",room_Name="",door_name="",panel_id="",device_id="",bridgeId="",lockId="",lockName="",door_sensor_module_id="",door_type="",lock_data="",lock_id="";
...
//        bridgeId=getIntent().getStringExtra("gatewayId");
