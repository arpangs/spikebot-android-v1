...
public class TTlockinfoActivity extends AppCompatActivity implements View.OnClickListener, DoorSensorInfoAdapter.OnNotificationContextMenu, ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onResume() {
        ...
        if (!door_subtype.equals("1") && Constants.lockDate < 86400 || TextUtils.isEmpty(Common.getPrefValue(TTlockinfoActivity.this, Constants.lock_token))) {
    ...
    private Emitter.Listener doorsensorvoltage = new Emitter.Listener() {
        ...
        public void call(final Object... args) {
            ...
            TTlockinfoActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
...
/*
                            if (device_id.equals(door_sensor_id)) {
                                if (!TextUtils.isEmpty(device_status) && !device_status.equals("null") && device_status.length() > 0) {
    ...
    private void fillData(RemoteDetailsRes.Data doorSensorResModel) {
        ...
        if (doorSensorResModel.getAlerts()!=null && doorSensorResModel.getAlerts().size()>0) {
            ...
            txtAlertTempCount.setText(doorSensorResModel.getAlerts().size() + " Notification");
            tempSensorInfoAdapter = new DoorSensorInfoAdapter(doorSensorResModel.getAlerts(), true, TTlockinfoActivity.this);
            door_sensor_list.setAdapter(tempSensorInfoAdapter);
        } else {
            txtAlertTempCount.setText("0" + " Notification");
...
//                }
        ...
        if (doorSensorResModel.getUnseenLogs()!=null && doorSensorResModel.getUnseenLogs().size()>0) {
            ...
            DoorAlertAdapter doorAlertAdapter = new DoorAlertAdapter(TTlockinfoActivity.this, doorSensorResModel.getUnseenLogs());
...
//        }
    ...
    private void Autolockdialog() {
        final Dialog dialog = new Dialog(TTlockinfoActivity.this);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean isBtEnable = TTLockClient.getDefault().isBLEEnabled(TTlockinfoActivity.this);
                if (!isBtEnable) {
                    TTLockClient.getDefault().requestBleEnable(TTlockinfoActivity.this);
                }
                dialog.dismiss();
                setAUtolock();
...
//        });
    ...
    public void showBottomSheetDialog() {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(TTlockinfoActivity.this, R.style.AppBottomSheetDialogTheme);
        dialog.setContentView(view);
        dialog.show();

        txt_bottomsheet_title.setText("What would you like to do in" + " " + doorSensorResModel.getDevice().getDeviceName() + " " + "?");
...
//        }
        ...
        btn_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChatApplication.keyBoardHideForce(TTlockinfoActivity.this);
                dialog.dismiss();
            }
        });
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edSensorName.getText().toString().length() == 0) {
                    ChatApplication.showToast(TTlockinfoActivity.this, "Please enter name");
                } else {
...
//                }
    ...
    private void doorSensorNotification(final RemoteDetailsRes.Data.Alert notification, final boolean isEdit) {
        ...
        button_save_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityHelper.hideKeyboard(TTlockinfoActivity.this);
    ...
    private void showTimePickerDialog(final EditText edtText, final boolean isStartTime) {
        ...
        DialogFragment fromTimeFragment = new TimePickerFragment12(TTlockinfoActivity.this, edtText.getText().toString(), new ICallback() {
            @Override
        ...
        if (!fromTimeFragment.isVisible()) {
            fromTimeFragment.show(TTlockinfoActivity.this.getFragmentManager(), "TimePicker");
        }
    ...
    private void addNotification(final Dialog doorSensorNotificationDialog, EditText stat_time, final EditText end_time, boolean isEdit,RemoteDetailsRes.Data.Alert  notification) {
        ...
        if (ChatApplication.url.contains("http://"))
            ChatApplication.url = ChatApplication.url.replace("http://", "");
        SpikeBotApi.getInstance().addNotification(params, isEdit,
...
//        }).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    public void checkIntent(boolean b) {
        if (b) {
            Intent intent = new Intent(TTlockinfoActivity.this, DeviceLogActivity.class);
            ...
            TTlockinfoActivity.this.finish();
        }
        return;
    }
