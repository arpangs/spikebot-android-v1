...
/**
 * Created by Sagar on 28/2/18.
 * Gmail : jethvasagar2@gmail.com
 */

public class TimePickerFragment24Hours extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    private Activity activity;
    private Date selectedDate;
    private ICallback callback;
    private boolean is24Hour = false;

    public TimePickerFragment24Hours(Activity activity, String selectedDate, ICallback callback) {
