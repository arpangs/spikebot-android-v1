...
public class ExpandableRecyclerView extends RecyclerView
{
    ...
    public static class SimpleGroupViewHolder extends GroupViewHolder
    {
        ...
        {
            super(View.inflate(context, R.layout.row_cameralist_view, null));
...
//            itemView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
            ...
            toggle_button_section =  itemView.findViewById(R.id.toggle_button_section);

            itemView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
//                    toggle_button_section.setChecked(expanded);
                }
            });
