...
public class DeviceLogNewAdapter extends RecyclerView.Adapter<DeviceLogAdapter.ViewHolder> {
    ...
    @Override
    public DeviceLogAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(viewType, parent, false);
        return new DeviceLogAdapter.ViewHolder(view , viewType);
    }

    @Override
    public void onBindViewHolder(final DeviceLogAdapter.ViewHolder holder, final int listPosition) {
    ...
    @Override
    public void onViewDetachedFromWindow(DeviceLogAdapter.ViewHolder holder) {
        super.onViewDetachedFromWindow(holder);
        ((DeviceLogAdapter.ViewHolder)holder).clearAnimation();
    }
